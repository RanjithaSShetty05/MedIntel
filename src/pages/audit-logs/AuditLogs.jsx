  ...
  const filteredLogs = useMemo(() => {
    ...
    return auditLogs.filter((log) => {
      ...
      return (
        ...
        log.entityId.toLowerCase().includes(value) ||
        log.performedBy.toLowerCase().includes(value) ||
    ...
    <div className="mx-auto max-w-[1500px] space-y-6">
            ...
            <table className="w-full min-w-[1050px] text-left">
              ...
              <tbody>
                {currentLogs.map((log) => {
                  ...
                  const EntityIcon =
                    entityIcons[log.entity] || FiFileText
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-sm font-medium text-slate-700">
                              {log.date.split(" ").slice(0, 3).join(" ")}
                            </p>

                            <p className="mt-0.5 flex items-center gap-1 text-xs text-slate-400">
                              <FiClock className="h-3 w-3" />
                              {log.date.split(" ").slice(3).join(" ")}
                            </p>
                          </div>
      ...
      <div className="rounded-xl border border-blue-100 bg-blue-50 p-4">
        <p className="text-xs leading-5 text-blue-700">
          Audit logs provide a record of important system
          activities to support accountability, traceability,
